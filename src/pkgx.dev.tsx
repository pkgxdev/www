...
import { useTheme, CssBaseline, Box, Grid, Button, Stack, Typography, Paper, ButtonBase, useMediaQuery } from '@mui/material';
...
function Body() {
  ...
  return <Stack direction="column" width={isxs ? undefined : 'min-content'} maxWidth='md' sx={{p: 2, minHeight: '100vh'}} mx='auto' spacing={4} alignItems='center'>
      ...
      <Stack direction={isxs ? 'column' : 'row'} spacing={isxs ? 2 : 4} alignItems='center'>
        ...
        <Button color='inherit' href='https://tea.xyz' size='small' endIcon={<ArrowForwardIcon />}>
          Learn More
        </Button>
      </Stack>
